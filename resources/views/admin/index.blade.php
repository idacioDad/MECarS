...
<div class="row">
                ...
                <div class="col-lg-3 col-md-6 col-sm-6">
                    <div class="card card-icon-bg card-icon-bg-primary o-hidden mb-4">
                        <div class="card-body text-center">
                            <i class="i-Money-2"></i>
                            <div class="content">
                                <p class="text-muted mt-2 mb-0">Gastos</p>
            ...
            <div class="row">
                <div class="col-lg-8 col-md-12">
                    <div class="card mb-4">
                        <div class="card-body">
                            <div class="card-title">Vendas deste Ano</div>
                ...
                <div class="col-lg-4 col-sm-12">
                    <div class="card mb-4">
                        <div class="card-body">
                            <div class="card-title">Vendas por Provincia</div>
                    ...
                    <div class="row">
                        <div class="col-lg-6 col-md-12">
                            <div class="card card-chart-bottom o-hidden mb-4">
                                <div class="card-body">
                                    <div class="text-muted">Vendas do ultimo mes</div>
    ...
    <script src="{{asset('admin/js/vendor/echarts.min.js')}}"></script>
    <script src="{{asset('admin/js/es5/echart.options.min.js')}}"></script>
    <script src="{{asset('admin/js/es5/dashboard.v1.script.js')}}"></script>
    <script src="{{asset('admin/js/script.js')}}"></script>
    <script src="{{asset('admin/js/sidebar.compact.script.js')}}"></script>
    <script src="{{asset('admin/js/customizer.script.js')}}"></script>
